...
import 'package:we_lean/screens/root_cause_analysis_daily.dart';
...
class RootCauseAnalysisWeekly extends StatefulWidget {
  const RootCauseAnalysisWeekly({Key? key}) : super(key: key);

  @override
  _RootCauseAnalysisWeeklyState createState() => _RootCauseAnalysisWeeklyState();
}

class _RootCauseAnalysisWeeklyState extends State<RootCauseAnalysisWeekly> {
                                ...
                                children: [
                                  ...
                                  ListTile(
                                    leading: Container(
                                        ...
                                        child: Icon(Icons.compass_calibration_outlined,color: Colors.white,size: 25,)),
                                    ...
                                    onTap: (){
                                      CustomNavigation.push(context,BlocProvider(
                                        ...
                                        child:  RootcauseAnalysisDaily(week_plan_id: state.userLocationPlans[index].id),
                                      ),);
                                    },
                                  ),
                                  Divider()
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10,),
                        Center(child: Text("No rootcause data available",style: titilliumBold,)),
                      ],
                    ),
                  ),
                );
